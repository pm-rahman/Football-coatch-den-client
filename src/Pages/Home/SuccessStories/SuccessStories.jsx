    ...
    return (
        <div className="py-16 px-5 md:px-10 lg:px-20">
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-6">
                <div className="bg-base-200 grid md:grid-cols-2 md:h-[300px]">
                    <img src={student1} className="rounded-lg h-full shadow-2xl" />
                    <div className="p-4 h-[300px] overflow-scroll">
                ...
                <div className="bg-base-200 grid md:grid-cols-2 md:h-[300px]">
                    <img src={student2} className="rounded-lg h-full shadow-2xl" />
                    <div className="p-4 h-[300px] overflow-scroll">

...
const PopularInstructors = () => {
    ...
    return (
        <div className={`py-16 px-5 md:px-10 lg:px-20  ${dark?'bg-slate-100 text-[rgb(1,16,31)]':'bg-[rgb(1,16,31)] lg:bg-inherit text-white'}`}>
            <SectionTitle
            ...
            <div className="grid md:grid-cols-3 gap-5 mt-8">
                {
                    instructors.map((item, index) => <div
                        key={index}
                        className={`shadow rounded-md ${dark?'text-[rgb(1,16,31)]':'shadow-white lg:text-white'}`}
                    >

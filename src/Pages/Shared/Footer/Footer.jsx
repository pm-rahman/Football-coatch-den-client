...
const Footer = () => {
    ...
    return (
        <div className={`px-5 md:px-10 lg:px-20 pt-10 pb-10 lg:pb-20 ${!dark?`text-white bg-[rgb(1,16,31)] ${noHome?'bg-[rgb(1,16,31)]':'lg:bg-inherit'}`:`${noHome&&'bg-[rgb(1,16,31)]'} bg-slate-100`}`}>
